...
Devise.setup do |config|
  ...
  config.secret_key = %w[
    42d1856cf4198478e1c27afb39668aaeafa1833b47aea32700fade42af0fd09f
    f67f68ec8c155a56184854130a5a0a859f926832ddd01fdfb6d49e64d956aa2d
  ].join
  ...
  config.mailer_sender = 'please-change-me-at-config-initializers@example.com'
  ...
  # be passed to the find_for_authentication method
  ...
  # These keys will be downcased upon creating or modifying a user
  # and when used
  ...
  # to not use a value less than 10 in other environments.
  config.stretches = Rails.env.test? ? 1 : 10

  # Setup a pepper to generate the encrypted password.
  # config.pepper = %w[
  #   9265652bc286cbcb251488dbab0d61e51d3ceb058445697877411659011d78bc
  #   dd2e7eba9c22ab65d723958a4f845dfa3a2e2875fe635c48a5ab8364768d7ec3
  # ].join
