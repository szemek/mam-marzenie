...
describe SponsorsController do
  ...
  describe "GET index" do
    xit "assigns all sponsors as @sponsors" do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sponsor as @sponsor" do
        ...
        post :create, {:sponsor => { "fullname" => "invalid value" }}, valid_session
        expect(assigns(:sponsor)).to be_a_new(Sponsor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sponsor" do
        ...
        expect_any_instance_of(Sponsor).to receive(:update).with({ "fullname" => "" })
        put :update, {:id => sponsor.to_param, :sponsor => { "fullname" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sponsor as @sponsor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sponsor.any_instance.stub(:save).and_return(false)
        put :update, {:id => sponsor.to_param, :sponsor => { "fullname" => "invalid value" }}, valid_session
        expect(assigns(:sponsor)).to eq(sponsor)
      end
